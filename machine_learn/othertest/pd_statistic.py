...
def main(create_time, to_time):
    ...
    sql_pre = "select c.name as center, o.order_id, o.order_status, s.channel as platform, s.name as store_name, o.paid_time,a.order_id as note from `order` o inner join store s on o.store_idstore_id=s.idstore inner join alert_order_record a on o.idorder=a.order_idorder_id left join system_channelcenter c on c.id=s.channelcenter"
...
if  '__main__' == __name__:
    create_time = '2020-01-05T00:00:00'
    to_time = '2020-01-12T00:00:00'
